...
class Transaction {
  ...
  constructor({version, flag, inputs, outputs, lockTime, rwrdTime}) {
    this.version = version
    this.flag = flag
    this.inputs = inputs
    this.outputs = outputs
    this.lockTime = lockTime
    this.rwrdTime = rwrdTime
  }
  ...
  static fromBufferReader(reader) {
    ...
    rwrdTime = reader.readUInt32LE()
    return new Transaction({version, flag, inputs, outputs, lockTime, rwrdTime})
  }
  ...
  toBufferWriter(writer) {
    ...
    writer.writeUInt32LE(this.rwrdTime)
  }
